...
seajs.config({
    ...
    alias : {
        ...
        'BaiduUploader' : '{projectModuleBase}/webuploader/0.1.5/baiduUploader',
        'baiduUploader' : 'baiduUploader/0.1.5/webuploader.html5only.min',
        // input元素只允许输入数字
        'numeral': 'numeral/1.0/numeral',
        // 图片查看器
        'viewer': 'viewer/0.5.1/viewer',
        'uploader' : '{projectModuleBase}/admin/uploader/{moduleVersion}/uploader',
        /** *************项目级别模块************ */
        'adminSystem' : '{projectModuleBase}/admin/system/{moduleVersion}/system',
        //基于iCheckBox插件
        'dataGridHelp' : '{projectModuleBase}/dataGridHelp/{moduleVersion}/dataGridHelp'
