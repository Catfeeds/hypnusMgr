...
define('select/1.0/select', ['$', 'select/1.0/{theme}/css/select.css'],
    function (require, exports, module) {
        ...
        function createSelect(target) {
            ...
            var id = prefixName + '_select_' + $(target).attr('id');
            ...
            if (opts.size != null && opts.size == 'big') {
                ...
                // 是否显示查询框
                if (opts.isShowQuery) {
                    var id = prefixName + '_select_qry_' + new Date().getTime();
        ...
        $.fn.select = function(options, param){
            ...
            return this.each(function() {
                ...
                if (state) {
                    ...
                    SELECT_SERNO++;
                    state.itemIdPrefix = '_'+ prefixName + '_sel_i' + SELECT_SERNO;
                    state.groupIdPrefix = '_'+ prefixName + '_sel_g' + SELECT_SERNO;
                    bindEvents(this);
