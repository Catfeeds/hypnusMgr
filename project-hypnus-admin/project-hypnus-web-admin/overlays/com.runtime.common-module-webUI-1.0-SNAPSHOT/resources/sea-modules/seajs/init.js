...
seajs.config({
	...
	alias : {
		...
		// 'base':'common/pc/1.0/base',
		'base':'common/pc/2.0/base',
		// 'loadingTip':'loadingTip/1.0/loadingTip',
		'loadingTip':'loadingTip/2.0/loadingTip',
		// 截图插件
		...
		'notification':'notification/1.0/notification',
		'consoleHack':'consoleHack/1.0/consolehack',

        // 中介者模式工具类，可发布和订阅事件
        'mediator': 'mediator/1.0/mediator',

        // input元素只允许输入数字
        'numeral': 'numeral/1.0/numeral',

        //附件模块
        'attachment' : 'attachment/1.0/attachment',

        'baiduUploader' : 'baiduUploader/0.1.5/webuploader.min'

        /** *************项目级别模块************ */
	},
	/**预先加载base基础文件*/
	preload : [ 'common/pc/2.0/base','placeholderFix/{moduleVersion}/placeholderFix', 'consoleHack/1.0/consolehack']
});
