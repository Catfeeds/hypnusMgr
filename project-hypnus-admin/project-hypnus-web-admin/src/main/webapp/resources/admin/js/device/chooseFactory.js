        ...
        var EventHandler = function () {
            return {
                ...
                selectCus : function(){
                    ...
                    if (checked.length < 1) {
                        msgBox.tips("请勾选一个经销商");
                        return;
                    }
                    if(checked.length>1){
                        msgBox.tips("该设备只能绑定一个经销商");
                        return;
                    }
                    var factoryId = checked[0].id;
        ...
        var DataHandler = function () {
            return {
                ...
                search: function (param, callback) {
                    $.post(path + '/admin/factoryMgr/searchFactory', param, function (backData) {
                        callback(backData);
                    });
                }
            }
