...
<head>
    ...
    <title><config:Config key="platform_name" defaultValue="和普乐"/>管理平台</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="${path}" class="logo">
            ...
            <span class="logo-mini"><b title="和普乐管理平台">HPL</b></span>
            <%--<span class="logo-mini"><b></b></span>--%>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img title="和普乐管理平台" src="${path}/resources/images/img_index_logo.png" style="width:210px;text-align: center"></span>
