/**
 * Created by runtime on 2016/3/25.
 * 对应 http://res.wx.qq.com/open/js/jweixin-1.0.0.js
 */
!function (a, b) {
    "function" == typeof define && (define.amd || define.cmd) ? define("wechat/1.0/wechat", [], function () {
        return b(a)
    }) : b(a, !0)
}(this, function (a, b) {
    function c(b, c, d) {
    ...
    function k() {
        0 != D.preVerifyState && (u || v || E.debug || "6.0.2" > z || D.systemType < 0 || A || (A = !0, D.appId = E.appId, D.initTime = C.initEndTime - C.initStartTime, D.preVerifyTime = C.preVerifyEndTime - C.preVerifyStartTime, H.getNetworkType({
            ...
            success: function (a) {
                var b, c;
                D.networkType = a.networkType, b = "http://open.wechat.qq.com/sdk/report?v=" + D.version + "&o=" + D.preVerifyState + "&s=" + D.systemType + "&c=" + D.clientVersion + "&a=" + D.appId + "&n=" + D.networkType + "&i=" + D.initTime + "&p=" + D.preVerifyTime + "&u=" + D.url, c = new Image, c.src = b
            }
        })))
    }
