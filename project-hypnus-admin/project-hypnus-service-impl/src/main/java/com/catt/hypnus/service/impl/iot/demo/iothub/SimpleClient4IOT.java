 ...
 */
package com.catt.hypnus.service.impl.iot.demo.iothub;
...
public class SimpleClient4IOT {
	...
	/******这里是客户端需要的参数*******/
    public static String deviceName = "363338363035511100290036";
    public static String productKey = "TeapvKrZpFA";
    public static String secret = "8y0a3eyV15qLlIXgtbIrfdOOTvOkQUDG";
