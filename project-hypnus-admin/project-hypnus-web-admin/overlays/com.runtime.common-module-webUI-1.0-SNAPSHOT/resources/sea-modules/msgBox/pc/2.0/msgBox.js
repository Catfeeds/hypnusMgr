 ...
 * 4、警告提示框warn
 */
define('msgBox/pc/2.0/msgBox', ['$', 'layer', 'msgBox/pc/2.0/css/msgBox.css'],
        ...
        var msgBox = {
            ...
            alert: function (options) {
                if (window != top) {
                    ...
                    if (options.showCloseBtn) {
                        ...
                        var param = $.extend({title: options.title || '提示'}, options);
            ...
            confirm: function (options) {
                if (window != top) {
                    ...
                    var param = $.extend({title: options.title || '提示', btn: ['确定', '取消']}, options);
                    //询问框
            ...
            exWindow: {
                ...
                open: function (options) {
                    ...
                    if (window != top) {
                        ...
                        // 设置附加参数
                        extraParams = $.extend({}, options.extraParams);
                        var params = {
                            type: 2,
                        ...
                        if (typeof(options.closeBtn) != 'undefined' ) {
                            params.closeBtn = options.closeBtn ;
                        }
                 ...
                 * 1. A页打开B页，B页回传参数到A页，B页插入如下代码：
                 ...
                 msgBox.exWindow.close($.toJSON(point));
                 ...
                 msgBox.exWindow.open({
                    ...
                    close: function (result) {
                        if (result) {
                            ...
                            $("form#form_oilstationInfo input#longitude").val(result.longitude);
                            $("form#form_oilstationInfo input#latitude").val(result.latitude);
                        }
                    }
                });
                 ...
                 */
                getExtraParams: function (fn) {
                    if (window != top) {
                        top.seajs.use(module.id, function (msgBox) {
                            msgBox.exWindow.getExtraParams(fn);
                        });
                    } else {
                        fn(extraParams);
                    }
