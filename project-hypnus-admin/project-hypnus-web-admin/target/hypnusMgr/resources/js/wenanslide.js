...
var listjsonYing = [
    {text1:"图片1",url1:"images/072334sD5.jpg"},
	...
	{text1:"图片7",url1:"images/072334sD5.jpg"},
	{text1:"图片8",url1:"images/072334sD5.jpg"},
	{text1:"图片9",url1:"images/072334sD5.jpg"},
	{text1:"图片10",url1:"images/072334sD5.jpg"}
]
...
function apepndListYing(ListtjsonYing) {
	...
	for (var i = 0; i < ListtjsonYing.length; i++) {
		itemContent.push(
				'<div class="jd_box"><img class="pic1"  src="'+listjsonYing[i].url1+'" /><div class="eachtit">'+ ListtjsonYing[i].text1 +'</div></div>'
		);
