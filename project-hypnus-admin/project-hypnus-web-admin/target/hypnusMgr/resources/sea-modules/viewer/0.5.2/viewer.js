 ...
 * 图片查看器Viewer模块化
 */
define('viewer/0.5.2/viewer', ['$', 'viewer/0.5.2/dist/viewer.min.js', 'viewer/0.5.2/dist/viewer.min.css', 'util/1.0/util'],
    ...
    var viewerUtil = {
         ...
         */
        viewImage: function (imageUrls, currentImageUrl, validateImageExt, freeOptions) {
