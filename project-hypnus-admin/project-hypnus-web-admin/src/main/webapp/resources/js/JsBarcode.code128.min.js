...
!function (t) {
    ...
    var s = n(11), u = r(s), f = function (t) {
        function e(n, r) {
            i(this, e);
            var a = o(this, t.call(this, n.substring(1), r));
            a.bytes = [];
        ...
        return a(e, t), e.prototype.encode = function () {
            ...
            if (t[0] >= 200)r = t[0] - 105, t.shift(), 99 === r ? n = this.nextC(t, e + 1) : 100 === r ? n = this.nextB(t, e + 1) : 98 === r ? (t[0] = t[0] > 95 ? t[0] - 96 : t[0], n = this.nextA(t, e + 1)) : n = this.nextA(t, e + 1); else {
                var i = t[0];
                r = i < 32 ? i + 64 : i - 32, t.shift(), n = this.nextA(t, e + 1)
            }
            var o = this.getEncoding(r), a = r * e;
            return {result: o + n.result, checksum: a + n.checksum}
    ...
    function a(t, e, n) {
        for (var r = 0; r < t.length; r++) {
            var a, s = t[r], u = (0, l.default)(e, s.options);
    ...
    function i(t) {
        ...
        if (t.getContext)return {element: t, renderer: c.default.CanvasRenderer};
    ...
    function a(t) {
        ...
        return {
            element: e, options: (0, u.default)(t), renderer: c.default.CanvasRenderer, afterRender: function () {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var s = n(17), u = r(s), f = n(19), c = r(f), l = n(2);
    e.default = i
}, function (t, e) {
    "use strict";
    function n(t) {
    ...
    var s = n(1), u = r(s), f = function (t) {
        function e(n, r) {
            return i(this, e), o(this, t.call(this, String.fromCharCode(208) + n, r))
        }
    ...
    var s = n(1), u = r(s), f = function (t) {
        function e(n, r) {
            return i(this, e), o(this, t.call(this, String.fromCharCode(209) + n, r))
        }
    ...
    var s = n(1), u = r(s), f = function (t) {
        function e(n, r) {
            return i(this, e), o(this, t.call(this, String.fromCharCode(210) + n, r))
        }
    ...
    function s(t) {
        ...
        return e = i >= 2 ? String.fromCharCode(210) + c(t) : n > r ? String.fromCharCode(208) + u(t) : String.fromCharCode(209) + f(t), e = e.replace(/[\xCD\xCE]([^])[\xCD\xCE]/, function (t, e) {
    ...
    function c(t) {
        ...
        return r >= i ? e + String.fromCharCode(206) + u(t) : e + String.fromCharCode(205) + f(t)
    }

    Object.defineProperty(e, "__esModule", {value: !0});
    var l = n(1), d = r(l), h = function (t) {
        function e(n, r) {
            if (i(this, e), n.search(/^[\x00-\x7F\xC8-\xD3]+$/) !== -1)var a = o(this, t.call(this, s(n), r)); else var a = o(this, t.call(this, n, r));
            return o(a)
        }
    ...
    var i = n(15), o = r(i), a = n(12), s = r(a), u = n(13), f = r(u), c = n(14), l = r(c);
    e.CODE128 = o.default, e.CODE128A = s.default, e.CODE128B = f.default, e.CODE128C = l.default
}, function (t, e, n) {
    "use strict";
    function r(t) {
        return t && t.__esModule ? t : {default: t}
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var o = n(0), a = r(o), s = n(5), u = function () {
        function t(e, n, r) {
        ...
        return t.prototype.render = function () {
            ...
            var n, r = this.canvas.getContext("2d"), i = e.data;
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(18), o = r(i), a = n(20), s = r(a);
    e.default = {CanvasRenderer: o.default, SVGRenderer: s.default}
}, function (t, e, n) {
    "use strict";
    function r(t) {
        return t && t.__esModule ? t : {default: t}
    ...
    var u = n(0), f = r(u), c = n(5), l = "http://www.w3.org/2000/svg", d = function () {
        ...
        return t.prototype.render = function () {
            ...
            for (var e = 0; e < this.encodings.length; e++) {
                var n = this.encodings[e], r = (0, f.default)(this.options, n.options), i = o(t, r.marginTop, this.svg);
    ...
    function i(t, e) {
        O.prototype[e] = O.prototype[e.toUpperCase()] = O.prototype[e.toLowerCase()] = function (n, r) {
            ...
            return i._errorHandler.wrapBarcodeCall(function () {
                var a = (0, l.default)(i._options, r);
                a = (0, m.default)(a);
                var s = t[e], u = o(n, s, a);
    ...
    function o(t, e, n) {
        ...
        var i = r.encode();
        i = (0, h.default)(i);
        for (var o = 0; o < i.length; o++)i[o].options = (0, l.default)(n, i[o].options);
        return i
    }
    ...
    function s(t, e, n) {
        ...
        (0, g.default)(n);
        var i = t.renderer, o = new i(t.element, e, n);
        o.render(), t.afterRender && t.afterRender()
    }

    var u = n(6), f = r(u), c = n(0), l = r(c), d = n(10), h = r(d), p = n(8), g = r(p), v = n(9), x = r(v), y = n(3), m = r(y), b = n(7), C = r(b), w = n(2), _ = n(4), E = r(_), O = function () {
    }, A = function (t, e, n) {
        var r = new O;
        if ("undefined" == typeof t)throw Error("No element to render on was provided.");
        return r._renderProperties = (0, x.default)(t), r._encodings = [], r._options = E.default, r._errorHandler = new C.default(r), "undefined" != typeof e && (n = n || {}, n.format || (n.format = a()), r.options(n)[n.format](e, n).render()), r
    };
        ...
        if (this._renderProperties) {
            ...
            for (var e in this._renderProperties) {
                ...
                "auto" == n.format && (n.format = a()), this._errorHandler.wrapBarcodeCall(function () {
                    var e = n.value, r = f.default[n.format.toUpperCase()], i = o(e, r, n);
                    s(t, i, n)
                })
            }
        }
